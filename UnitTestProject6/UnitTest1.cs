...
namespace UnitTestProject6
{
    ...
    public class FooBarQixTests
    {
        ...
        {
            FooBarQix fooBarQix = new FooBarQix();
            var what = fooBarQix.What(15);
            Assert.AreEqual("FooBarBar", what);
        }
        ...
        {
            FooBarQix fooBarQix = new FooBarQix();
            var what = fooBarQix.What(33);
            Assert.AreEqual("FooFooFoo", what);
        }
        ...
        {
            FooBarQix fooBarQix = new FooBarQix();
            var what = fooBarQix.What(51);
            Assert.AreEqual("FooBar", what);
        }
        ...
        {
            FooBarQix fooBarQix = new FooBarQix();
            var what = fooBarQix.What(53);
            Assert.AreEqual("BarFoo", what);
        }
    }
}